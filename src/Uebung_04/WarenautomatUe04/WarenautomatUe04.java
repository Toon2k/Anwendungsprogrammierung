package Uebung_04.WarenautomatUe04;

public class WarenautomatUe04
{
    ...
    public WarenautomatUe04(int anzahlEdamerbroetchen, int anzahlSalamibroetchen) {
        this.anzahlEdamerbroetchen = anzahlEdamerbroetchen;
        this.anzahlSalamibroetchen = anzahlSalamibroetchen;
    }

    public WarenautomatUe04() {
